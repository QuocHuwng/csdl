...
-- bai 1 mô phỏng “đăng ký tài khoản”.
...
-- bai 2 tạo “hồ sơ công khai”: chỉ lộ thông tin an toàn (không lộ password/email).
...
-- bai 3 đo “kế hoạch chạy + thời gian thực tế” của query.
EXPLAIN ANALYZE
select * from users
...
-- bai 4 chỉ insert nếu user tồn tại
delimiter $$
...
-- bai 5 chỉ lấy bài viết 7 ngày gần nhất.
...
-- bai 6 tăng tốc lọc post theo user.
...
-- bai 7 đóng gói thống kê “user có bao nhiêu post”.
delimiter //
...
-- bai 8 chỉ thao tác (insert/update) thông qua view với user “active”.
...
-- bai 10 gợi ý người chưa kết bạn với mình.
delimiter $$
...
-- bai 11 tăng tốc join/đếm like theo post.
...
-- bai 12 thêm comment nhưng phải check user + post tồn tại.
delimiter $$
...
-- bai 13 ngăn like trùng (mỗi user chỉ like 1 lần/post).
--  sp_like_post
delimiter $$
